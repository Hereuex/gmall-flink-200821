...
public class OrderWideApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //4、双流join
        SingleOutputStreamOperator<OrderWide> orderWideDS = orderInfoWithIdKeyedStream.intervalJoin(orderDetailWithIdKeyedStream).between(Time.seconds(-5), Time.seconds(5)).process(new ProcessJoinFunction<OrderInfo, OrderDetail, OrderWide>() {
            @Override
